The system on chip(SoC) of the raspberry pi has a temperature sensor. This project shows the measurement from the temperature sensor in the rapsberry pi and shows the data in visualized graph.
